...
//public enum Modes { BikeVsBike, CarVsCar, CarVsBike, BikeVsCar }
    ...
    public enum CarState { Main, VehicleSelect, TrackSelect, Customize, Settings, Loading ,PlayerSelection}
    ...
    public class CarSelect : MonoBehaviour
    {
        ...
        void CycleVehicles()
        {
            ...
            for (int i = 0; i < menuVehicles.Length; i++)
            {
                if (vehicleIndex == i)
                {
                     currentpos = menuVehicles[i].vehicle.gameObject.transform.position;
                ...
                else
                {
                    ...
                    menuVehicles[i].vehicle.transform.position = currentpos;
                }
            }
        }
