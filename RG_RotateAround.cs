// Code auto-converted by Control Freak 2 on Thursday, October 05, 2017!
using UnityEngine;
...
//		target = GameObject.FindWithTag ("Player").gameObject.transform;
		 cur_scene = SceneManager.GetActiveScene().buildIndex;
//
//		if(cur_scene == 1){
//
//
//		target = GameObject.Find ("Canvas").gameObject.GetComponent<car_selection> ().cars [PlayerPrefs.GetInt ("current_car", 0)].gameObject.transform;
//
//
//		}
//		if(cur_scene == 2){
//
//
//			target = GameObject.Find ("Canvas").gameObject.GetComponent<car_modification> ().car [PlayerPrefs.GetInt ("current_car", 0)].gameObject.transform;
//
//
//		}
